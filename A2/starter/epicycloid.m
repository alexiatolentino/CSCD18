...
%% Student 1:
%%
%%	Name: Alexia Tolentino   
%%	Student Number: 1006293967
%%	UTORid: tolent55
%%
%% Student 2:
%%
%%	Name: Reem Al Halabi
%%	Student Number: 1006321927
%%	UTORid: alhala16
%%
...
%% Sign with your name:
%%
%%	Student 1: Alexia Tolentino
%%
%%	Student 2: Reem Al Halabi
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=0:.05:12*pi
  ...
  tx=-((R+r)*sin(i)) + ((R+r)*sin(((R+r)/r)*i));
  ty=((R+r)*cos(i)) - ((R+r)*cos(((R+r)/r)*i));         % DUMMY VECTOR, replace with correct one. 
  tz=-R*sin((R/r)*i);
